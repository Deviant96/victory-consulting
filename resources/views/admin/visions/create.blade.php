...
<div class="bg-white rounded-xl shadow p-6">
    <h1 class="text-3xl font-bold text-gray-900 mb-6">Add Vision</h1>

    <form action="{{ route('admin.visions.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="mb-6">
            ...
            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
            @enderror
            <p class="text-gray-500 text-sm mt-1">Recommended: Image of a woman offering handshake positioned to the left</p>
        </div>
