...
<div class="bg-white rounded-xl shadow p-6">
    ...
    <form action="{{ route('admin.team.update', $team) }}" method="POST" enctype="multipart/form-data" x-data="expertiseManager()">
        ...
        <div class="mb-6">
            ...
            <input type="text" name="name" id="name" value="{{ old('name', $team->name) }}" required class="w-full px-4 py-2 border border-gray-300 rounded-xl focus:ring-blue-500 focus:border-blue-500 @error('name') border-red-500 @enderror">
            @error('name')
        ...
        <div class="mb-6">
            ...
            <input type="text" name="position" id="position" value="{{ old('position', $team->position) }}" required class="w-full px-4 py-2 border border-gray-300 rounded-xl focus:ring-blue-500 focus:border-blue-500 @error('position') border-red-500 @enderror">
            @error('position')
            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div class="mb-6">
            ...
            <textarea name="bio" id="bio" rows="4" class="w-full px-4 py-2 border border-gray-300 rounded-xl focus:ring-blue-500 focus:border-blue-500 @error('bio') border-red-500 @enderror">{{ old('bio', $team->bio) }}</textarea>
            @error('bio')
            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div class="mb-6">
            ...
            <input type="email" name="email" id="email" value="{{ old('email', $team->email) }}" class="w-full px-4 py-2 border border-gray-300 rounded-xl focus:ring-blue-500 focus:border-blue-500 @error('email') border-red-500 @enderror">
            @error('email')
            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div class="mb-6">
            ...
            <input type="url" name="linkedin" id="linkedin" value="{{ old('linkedin', $team->linkedin) }}" class="w-full px-4 py-2 border border-gray-300 rounded-xl focus:ring-blue-500 focus:border-blue-500 @error('linkedin') border-red-500 @enderror">
            @error('linkedin')
            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
            @enderror
        </div>
