...
@section('content')
    <div class="flex justify-between items-center">
        ...
        <a href="{{ route('admin.translations.create') }}" class="inline-flex items-center px-4 py-2 bg-indigo-600 text-white text-sm font-semibold rounded-lg shadow hover:bg-indigo-700">
