...
<section class="py-20">
    <div class="container mx-auto px-4">
        <div class="max-w-4xl mx-auto text-center" data-animate="fade-up">
            <h1 class="text-5xl font-bold mb-6">{{ settings('industry.page_title', t('frontend.industry.heading', 'Industries We Serve')) }}</h1>
            <p class="text-xl opacity-90">
                {{ settings('industry.page_description', t('frontend.industry.subheading', "Whatever your business, we can handle it. Comprehensive solutions tailored to your industry's unique challenges and opportunities.")) }}
            </p>
        </div>
    </div>
</section>
        ...
        <div data-animate="fade-up">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <a href="{{ route('contact') }}" class="inline-flex items-center justify-center w-full sm:w-auto bg-white text-[#0481AE] px-8 md:px-12 py-3 md:py-4 rounded-xl font-semibold hover:bg-gray-100 transition shadow-lg text-base md:text-lg">
                    ...
                    {{ settings('industry.cta_button', t('frontend.industry.cta_primary', 'Book Free Consultation')) }}
                </a>
            </div>
        </div>
    </div>
