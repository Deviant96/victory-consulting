        ...
        <div class="max-w-6xl mx-auto">
            <div class="grid lg:grid-cols-2 gap-12">
                ...
                <div>
                    <div class="bg-white rounded-lg shadow-md p-8 mb-8">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <a href="tel:{{ settings('site.phone') }}" class="text-gray-600 hover:text-blue-600">
                                        {{ settings('site.phone') }}
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <a href="mailto:{{ settings('site.email') }}" class="text-gray-600 hover:text-blue-600">
                                        {{ settings('site.email') }}
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="mt-8 pt-8 border-t border-gray-200">
                            ...
                            <div class="flex gap-4">
                                ...
                                <a href="{{ settings('social.twitter') }}" target="_blank" class="bg-blue-100 p-3 rounded-lg hover:bg-blue-200 transition">
                                    <svg class="w-6 h-6 text-blue-600" fill="currentColor" viewBox="0 0 24 24">
                                ...
                                <a href="{{ settings('social.facebook') }}" target="_blank" class="bg-blue-100 p-3 rounded-lg hover:bg-blue-200 transition">
                                    <svg class="w-6 h-6 text-blue-600" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <!-- Business Hours -->
                    <div class="bg-blue-600 text-white rounded-lg shadow-md p-8">
