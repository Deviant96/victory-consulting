<footer class="bg-[#0481AE] text-gray-300">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <ul class="space-y-4 mb-10">
                    @if(settings('site.phone'))
                        <li class="flex items-start">
                            ...
                            <span class="text-gray-300">{{ settings('site.phone') }}</span>
                        </li>
                    @endif
                    ...
                    @if(settings('site.email'))
                        <li class="flex items-start">
                            ...
                            <span class="text-gray-300">{{ settings('site.email') }}</span>
                        </li>
                    @endif
                    ...
                    @if(settings('site.address'))
                        <li class="flex items-start">
                            ...
                            <span class="text-gray-300">{!! nl2br(e(settings('site.address'))) !!}</span>
                        </li>
                    @endif
                </ul>
        ...
        <!-- Bottom Bar -->
        <div class="border-t border-white mt-8 pt-8 text-center text-gray-300 text-sm">
