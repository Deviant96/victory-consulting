...
<section class="py-16 bg-white">
    <div class="container mx-auto px-4">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="bg-gray-50 rounded-lg p-8 mb-8" data-animate="fade-up" data-animate-delay="120">
                <h2 class="text-2xl font-bold text-gray-900 mb-6">{{ t('frontend.services.show.highlights_heading', 'Key Features') }}</h2>
                <div class="grid md:grid-cols-2 gap-4" data-animate-stagger="100">
                    @foreach($service->highlights as $highlight)
                    <div class="flex items-start" data-animate="fade-up">
            ...
            <!-- CTA Box -->
            <div class="bg-[#FFE7D5] text-white rounded-xl p-8 text-center mt-24 shadow-xl" data-animate="fade-up">
...
<section class="py-16 bg-gray-50">
    <div class="container mx-auto px-4">
        ...
        <div class="grid md:grid-cols-3 gap-8" data-animate-stagger="120">
            ...
            <a href="{{ route('services.show', $related->slug) }}" class="bg-white rounded-lg shadow-md hover:shadow-xl transition p-6 block" data-animate="fade-up">
